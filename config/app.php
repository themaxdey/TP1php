...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'a995f2cd3404d310f978692138373bb74542f92644264ff421472dbe54c7d4c1'),
    ],
    ...
    'EmailTransport' => [
        ...
        'davmail' => [
            'host' => 'localhost',
            'port' => 1025,
            'username' => '1641496@cmontmorency.qc.ca',
            'password' => '89z33A5',
            'className' => 'Smtp'
        ]
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'davmail',
            'from' => '1641496@cmontmorency.qc.ca',
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            //'database' => ROOT . DS . 'db' . DS . 'assetManagementSQLite.db',
            /*
